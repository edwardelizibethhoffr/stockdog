...
angular.module('stockDogApp')
  .directive('contenteditable', function ($sce) {
    return {
      restrict: 'A',
      require: 'ngModel', // [1] Get a hold og NgModelController

      link: function($scope, $element, $attrs, ngModelCtrl) {
     	if(!ngModelCtrl) { console.log("No ngModelCtrl!!!!"); return;} //do nothing if no ng-model
     	...
     	// [4] Add custom parser-based input type (only 'number' supported) - applied to the $modelValue
